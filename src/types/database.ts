...
export interface Profile { id:string; full_name:string; username:string; contact_email:string|null; role:StaffRole; is_active:boolean; created_at:string; updated_at:string }
